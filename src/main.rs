...
fn main() -> amethyst::Result<()> {
    ...
    let game_data = GameDataBuilder::default()
        ...
        // Add the input bundle which handles user input.
        ...
        // initialize it as thread_local which will always execute on the main thread.
...
impl GraphCreator<DefaultBackend> for ExampleGraph {
    ...
    fn rebuild(&mut self, res: &Resources) -> bool {
        // Rebuild when dimensions change, but wait until at least two frames
        // have the same.
    ...
    // This is the core of a RenderGraph, which is building the actual graph
    // with subpasses and target images.
    fn builder(
        &mut self,
        ...
        let color = graph_builder.create_image(
            ...
            1,
            surface_format,
            Some(ClearValue::Color([0.0, 0.0, 0.0, 1.0].into())), // clear screen to black
        );
